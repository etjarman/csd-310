...
CREATE TABLE `bacchuswinery`.`employee` (
  ...
  `Quarter` DECIMAL NULL,
  `Quarterly_time` DECIMAL NULL,
...
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (1, 'Janet', 'Collins', 1, 40, 1, '120', '2018-04-13', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (2, 'Roz', 'Murphy', 2, '40', 1, '120', '2016-06-20', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (3, 'Bob', 'Ulrich', 2, '32', 1, '96', '2021-11-10', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (4, 'Henry', 'Dole', 3, '40', 1, '120', '2018-07-07', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (5, 'Maria', 'Costanza', 4, '40', 1, '120', '2019-12-10', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (6, 'Joey', 'Gracie', 3, '24', 1, '72', '2022-07-01', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (7, 'Eveleen', 'Lemoine', 3, '24', 1, '72', '2022-07-07', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (8, 'Sully', 'Jake', 3, '24', 1, '72', '2022-07-14', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (9, 'Matty', 'Vale', 3, '24', 1, '72', '2022-07-21', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (10, 'Shanna', 'Houston', 3, '24', 1, '72', '2022-07-28', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (11, 'Trev', 'Rowena', 3, '24', 1, '72', '2022-08-4', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (12, 'Darla', 'Melba', 3, '24', 1, '72', '2022-08-11', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (13, 'Jed', 'Rosamond', 3, '24', 1, '72', '2022-08-18', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (14, 'Amos', 'Langston', 3, '24', 1, '72', '2022-08-25', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (15, 'Trisha', 'Suzie', 3, '24', 1, '72', '2022-09-01', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (16, 'Alecia', 'Brad', 3, '24', 1, '72', '2022-09-08', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (17, 'William', 'Babs', 3, '24', 1, '72', '2022-09-15', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (18, 'Martie', 'Ross', 3, '24', 1, '72', '2022-09-22', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (19, 'William', 'Babs', 3, '24', 1, '72', '2022-09-29', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (20, 'Freda', 'Gibson', 3, '24', 1, '72', '2022-10-06', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (21, 'Clive', 'Chet', 3, '24', 1, '72', '2022-10-13', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (22, 'Abram', 'Deacon', 3, '24', 1, '72', '2022-10-20', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (23, 'Ridge', 'Rosemarie', 3, '24', 1, '72', '2022-10-27', null);

  insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (24, 'Floyd', 'Eulalia', 3, '24', 1, '72', '2022-11-3', null);

 insert into bacchuswinery.employee (`Employee_id`, `Employee_first_name`, `Employee_last_name`, `Employee_dept_id`,
`Employee_time`, `Quarter`, `Quarterly_time`, `Start_date`, `Term_date`)
value (25, 'Coy', 'Nora', 3, '24', 1, '72', '2022-11-10', null);
...
`Component_name`, `Supply_order_date`, `Supply_delivery_date`, `Expected_delivery_date`, `Month_report`)
value (1, 'Vates Inc.', 500, 'Vates and Tubbing', '2023-5-25', '2023-6-30', '2023-6-30', 'January');

insert into bacchuswinery.supplier (`Supplier_id`, `Supplier_name`, `Supplier_inventory`,
`Component_name`, `Supply_order_date`, `Supply_delivery_date`, `Expected_delivery_date`, `Month_report`)
value (2, 'Boxes Inc.', '1000', 'Labels and Boxes', '2023-5-15', '2023-5-28', '2023-5-29', 'February');

insert into bacchuswinery.supplier (`Supplier_id`, `Supplier_name`, `Supplier_inventory`,
`Component_name`, `Supply_order_date`, `Supply_delivery_date`, `Expected_delivery_date`, `Month_report`)
value (3, 'Vates Inc.', '600', 'Bottles & Corks', '2023-5-1', '2023-5-15', '2023-5-16', 'March');
